...
export default class AdminBookingView extends React.Component {
    ...
    sortBookingsbyLocation = () => {
        {this.setState({filteredBookings :this.state.bookings.filter(booking => this.state.chosenLocation.includes(booking.deskRoom))});}
            ...
            <button
             disabled={!this.state.isCancelling || isUpcoming > 0}
                ...
                style={{
                    ...
                    "--hover-background":
                        isUpcoming > 0 ? "#eee" : this.state.isCancelling ? "#ff6655" : "#ddf8ff",
                    ...
                    this.state.bookings.length > 0 ? (
                         <button
                            ...
                            onClick={() =>{setTimeout(() => {
                                ...
                                if (res) {
                                    let currentData = JSON.parse(sessionStorage.bookings).data;
                                for (let index = 0; index < this.state.filteredBookings; index++) {
                                    if (index !== -1) {
                                        currentData.splice(index, 1);
                                        sessionStorage.removeItem("bookings");
                                        sessionStorage.setItem(
                    ...
                    {this.state.bookings ? (
                        ...
                        this.state.bookings.length > 0 ? (
                            ...
                            <div
                                ...
                                { this.state.chosenLocation!="" && this.state.chosenDate!=null ? (
                                <h2>No Bookings Found.</h2>):null}
